    ...
    <div className='pt-4 pr-4 pl-4 mx-auto'>
        ...
        <div className='grid grid-cols-4 grid-rows-1'>
            ...
            <span className='col-span-2 text-xs grid-cols-2'>
                ...
                <img className='float-right h-20 p-4 rounded-full ' src={spotifyUserState.spotifyUser.images[0] && spotifyUserState.spotifyUser.images[0].url} alt='spotify-user-img' />
            </span>
        </div>
            :
